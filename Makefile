...
compress_normal: CompressorNormal.o EscriptorBits.o EscriptorBits.hpp DimensionsIO.hpp
	$(CC) -o CompressorNormal CompressorNormal.o EscriptorBits.o

decompress_normal: DecompressorNormal.o LectorBits.o LectorBits.hpp DimensionsIO.hpp
